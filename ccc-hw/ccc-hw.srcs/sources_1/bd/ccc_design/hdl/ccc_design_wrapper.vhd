...
architecture STRUCTURE of ccc_design_wrapper is
  component ccc_design is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
begin
ccc_design_i: component ccc_design
     port map (
