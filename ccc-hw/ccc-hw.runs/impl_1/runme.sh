...
HD_PWD='/home/yarib/SOFTWARE_PROJECT/SoC_Hardware/ccc-hw/ccc-hw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ccc_design_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ccc_design_wrapper.tcl -notrace
