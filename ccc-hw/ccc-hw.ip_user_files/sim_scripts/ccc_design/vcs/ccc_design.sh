...
#
# Generated by Vivado on Sat Sep 16 18:17:57 CEST 2017
# IP Build 1412160 on Tue Nov 17 13:47:24 MST 2015 
#
# usage: ccc_design.sh [-help]
# usage: ccc_design.sh [-lib_map_path]
# usage: ccc_design.sh [-noclean_files]
# usage: ccc_design.sh [-reset_run]
#
...
# executing this script. Please type 'ccc_design.sh -help' for more information.
#
...
# Script info
echo -e "ccc_design.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"

# Script usage
usage()
{
  msg="Usage: ccc_design.sh [-help]\n\
Usage: ccc_design.sh [-lib_map_path]\n\
Usage: ccc_design.sh [-reset_run]\n\
Usage: ccc_design.sh [-noclean_files]\n\n\
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./ccc_design.sh -help\" for more information)\n"
  exit 1
fi
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./ccc_design.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key ccc_design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc ccc_design_simv.daidir)
...
create_lib_mappings()
{
  libs=(xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_8 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_7 fifo_generator_v13_0_1 axi_data_fifo_v2_1_6 axi_crossbar_v2_1_8 axi_lite_ipif_v3_0_3 interrupt_control_v3_1_3 axi_gpio_v2_0_9 lib_pkg_v1_0_2 axi_timer_v2_0_8 axi_protocol_converter_v2_1_7)
...
compile()
{
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    ...
    "$ref_dir/../../../bd/ccc_design/ip/ccc_design_processing_system7_0_0/sim/ccc_design_processing_system7_0_0.v" \
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/ccc_design/ip/ccc_design_rst_processing_system7_0_100M_0/sim/ccc_design_rst_processing_system7_0_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/ccc_design/ip/ccc_design_xbar_0/sim/ccc_design_xbar_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/ccc_design/ip/ccc_design_axi_gpio_0_1/sim/ccc_design_axi_gpio_0_1.vhd" \
    "$ref_dir/../../../bd/ccc_design/ipshared/user.org/espi_v1_0/src/espi.vhd" \
    "$ref_dir/../../../bd/ccc_design/ipshared/user.org/espi_v1_0/hdl/ESPI_v1_0_S00_AXI.vhd" \
    "$ref_dir/../../../bd/ccc_design/ipshared/user.org/espi_v1_0/hdl/ESPI_v1_0.vhd" \
    "$ref_dir/../../../bd/ccc_design/ip/ccc_design_ESPI_0_0/sim/ccc_design_ESPI_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/ccc_design/ip/ccc_design_axi_timer_0_0/sim/ccc_design_axi_timer_0_0.vhd" \
    "$ref_dir/../../../bd/ccc_design/ip/ccc_design_axi_timer_1_0/sim/ccc_design_axi_timer_1_0.vhd" \
    "$ref_dir/../../../bd/ccc_design/ip/ccc_design_axi_gpio_0_0/sim/ccc_design_axi_gpio_0_0.vhd" \
  2>&1 | tee -a vhdlan.log
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/ccc_design/ip/ccc_design_auto_pc_0/sim/ccc_design_auto_pc_0.v" \
  2>&1 | tee -a vlogan.log

  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/ccc_design/hdl/ccc_design.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.ccc_design xil_defaultlib.glbl -o ccc_design_simv
}
...
simulate()
{
  ...
  ./ccc_design_simv $opts -do simulate.do
}
# Script usage
usage()
{
